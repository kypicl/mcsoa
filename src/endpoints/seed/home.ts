              ...
              children: [
                {
                  ...
                  mode: 'normal',
                  style: '',
                  text: 'Marin County Section on Aging',
                  version: 1,
                },
              ],
              direction: 'ltr',
                ...
                children: [
                  {
                    ...
                    mode: 'normal',
                    style: '',
                    text: 'The speaker summaries below are displayed in an "Archive" layout building block. Posts can be individually selected and pagination controls will automatically appear if the number of results exceeds the number of items per page.',
                    version: 1,
                  },
                ],
                direction: 'ltr',
